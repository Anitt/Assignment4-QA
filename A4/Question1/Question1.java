...
public class Question1
{
	...
	public void Header(StringBuilder builder){
	...
	public void Footer(StringBuilder builder){

		builder.append("<A HREF=\"page2.html\">Click here to go to the next page!</A>\n");
	}

	public void Quotes(StringBuilder builder){
